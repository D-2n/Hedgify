import "../index.css";
import { getValue } from "../utils/wallet";
...
export default function Home() {
  ...
  //   const contract = await Tezos.contract.at(PriceFeedProxyAddress);
  ...
  return (
    <div className='bbuttoner'>
      <div className='buttoner'>
        <button className="button_call_function" onClick={() => {
          getValue();
